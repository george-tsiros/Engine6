...
public readonly struct Vector3d {
    ...
    public double Magnitude () => DoubleSqrt(MagnitudeSquared());
    ...
    public static Vector3d Min (in Vector3d a, in Vector3d b) => new(DoubleMin(a.X, b.X), DoubleMin(a.Y, b.Y), DoubleMin(a.Z, b.Z));
    public static Vector3d Max (in Vector3d a, in Vector3d b) => new(DoubleMax(a.X, b.X), DoubleMax(a.Y, b.Y), DoubleMax(a.Z, b.Z));
