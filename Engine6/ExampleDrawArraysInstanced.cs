...
public class ExampleDrawArraysInstanced:GlWindow {
    /*
...
*/
    ...
    protected override void Render () {
        throw new NotImplementedException("requires attributes to place diff models in scene and icba");
        ...
        //program.Color(new(0, .5f, .5f, 1));
        //program.Model(Matrix4x4.CreateFromYawPitchRoll(yaw, pitch, 0));
        //DrawArraysInstanced(Primitive.Triangles, 0, 
    }
