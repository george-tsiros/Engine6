...
public class Experiment:GlWindow {
    ...
    private VertexBuffer<Vector4> points;
    ...
    protected override void OnLoad () {
        ...
        SetSwapInterval(0);
        User32.MoveWindow(this, 0, 0, 2560, 1440, false);
    ...
    private void Update (double dt) {
        ...
        var xLocal = Vector3.Transform(Vector3.UnitX, modelOrientation);
        var yLocal = Vector3.Transform(Vector3.UnitY, modelOrientation);
        var zLocal = Vector3.Transform(Vector3.UnitZ, modelOrientation);
        modelPosition += timeScale * Axis(Key.Insert, Key.Delete) * xLocal;
        modelPosition += timeScale * Axis(Key.Home, Key.End) * yLocal;
        modelPosition += timeScale * Axis(Key.PageUp, Key.PageDown) * zLocal;
    }
