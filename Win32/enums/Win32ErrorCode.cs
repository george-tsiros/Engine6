...
public enum Win32ErrorCode {
    ...
    NO_SUCH_DEVICE = 433,
    FILE_SNAP_IN_PROGRESS = 435,
    UNSATISFIED_DEPENDENCIES = 441,
    CASE_SENSITIVE_PATH = 442,
    DLP_POLICY_SILENTLY_FAIL = 449,
    ...
    CIMFS_IMAGE_CORRUPT = 470,
    DEVICE_HARDWARE_ERROR = 483,
    INVALID_ADDRESS = 487,
    HAS_SYSTEM_CRITICAL_FILES = 488,
    VRF_CFG_AND_IO_ENABLED = 1183,
